...
Start by creating a new project in Android Studio. I used **Java**, but Kotlin works too. Choose an **Empty Activity**, set your minimum SDK to 21 or higher, and name your project something like `SensorDetector`.
...
Here’s a quick example of the layout (`activity_main.xml`):
